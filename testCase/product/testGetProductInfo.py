...
productInfo_xls = commonclass.get_xls("productCase.xlsx", "getProductInfo")
...
class ProductInfo(unittest.TestCase):
    ...
    def testGetProductInfo(self):
        ...
        """
        # set uel
        self.url = commonclass.get_url_from_xml('productInfo')
    ...
    def checkResult(self):
        ...
        if self.result == '0':
            ...
            goods_id = commonclass.get_value_from_return_json(self.info, "Product", "goods_id")
