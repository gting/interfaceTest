...
getAddress_xls = commonclass.get_xls("userCase.xlsx", "getAddress")
...
class GetAddress(unittest.TestCase):
    ...
    def testGetAddressList(self):
        ...
        """
        # set url
        self.url = commonclass.get_url_from_xml('getAddress')
    ...
    def checkResult(self):
        ...
        if self.result == '0':
            ...
            value = commonclass.get_value_from_return_json(self.info, "address", "addressId")
